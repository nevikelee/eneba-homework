...
const Navigation: React.FC<NavbarProps> = ({ onSearch }) => {
  ...
  return (
    <div className="outerWrapper">
      ...
      {isMenuOpen && (
        <div
          className={`menuOverlay ${isMenuClosing ? "closing" : ""}`}
          onClick={closeMenu}
        >
          <div
            className={`menuContent ${isMenuClosing ? "closing" : ""}`}
          ...
          >
            <div className="menuHeader">
              ...
              <button className="closeMenu" onClick={closeMenu}>
                {" "}
                <X className="closeMenu" size={30} strokeWidth={0.75} />
              </button>
            </div>
